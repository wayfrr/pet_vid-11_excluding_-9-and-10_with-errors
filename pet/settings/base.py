...
#above one line of code from vid#9 python eat tail
...
# specified to enforce i118n-patterns when calling LOGIN_URL or LOGIN_REDIRECT_URL
# reverse_lazy because parameters  have not yet been defined
LOGIN_URL = reverse_lazy('account_login')
LOGIN_REDIRECT_URL = reverse_lazy('account_profile')
#above two lines of code from vid#9 python eat tail
